...
{show && (
      ...
      <Modal visible={modalOpenOne} animationType='slide' style={styles.model}>
        <View style={styles.modelView}>
          ...
          <Text style={styles.modelHeadText}>Maternity Clinic</Text>

          <View style={styles.babyDetails}>

            <View style={styles.vaccineDetailsCard}>        
              <Text style={styles.cardtextName}>Appointment</Text>         
            </View>
...
{/* ******************************************************************************************************** */}
      <View>  
        <Text style={styles.headText}>Maternity Clinic</Text>
        <Text style={styles.headTextsmall}>Book your appointment online.</Text>   
      </View>
      ...
      <View style={styles.containerwhite}>
        <View style={styles.containerwhite}>
          ...
          <TouchableOpacity style={styles.appointmentcardOne} onPress={()=> setModalOpenOne(true)}>
            <Text style={styles.appointmentDes}>Book Appointment</Text>
          </TouchableOpacity>
